...
/*
 * Author: Aniketh B R
 * Connect Four Game developed using JavaFx
 */
...
public class Main extends Application {
    ...
    private void aboutMe() {
        ...
        alert.setContentText("I love to create games. " +
                ...
                " I am currently persuing my BE degree, and connect4 is my second game in JavaFx platform." +
                " I developed Connect4 Game with the help of Internshala Trainings." +
                " Hope you liked and enjoyed playing my connect4 game.");
        alert.show();
    }
    ...
    private void aboutConnect4() {
        ...
        alert.setContentText("Connect Four is a two-player connection game" +
                ...
                "of four of one's own discs. Connect Four is a solved game. The first player can " +
